...
GIT_DEPS_USER=(wpumacay wpumacay RobotLocomotion wpumacay gabime wpumacay wpumacay google phcerdan)
GIT_DEPS_BRANCH=(master master drake docking v1.x master master master cmake_for_easier_integration)
